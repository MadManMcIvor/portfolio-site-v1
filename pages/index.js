...
import alex from "../public/alex_avatar.png"
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className=' bg-slate-50 px-10 md:px-20 lg:px-40 dark:bg-slate-600'>
        <section className="min-h-screen">
          ...
          <div className=' text-center p-10'>
            ...
            <h3 className='text-2xl py-2 md:text-3xl dark:text-white'>Full Stack Software Engineer</h3>
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-white'>I'm a driven full stack software engineer. HIRE ME FOR THE LOVE OF GOD!</p>
          </div>
